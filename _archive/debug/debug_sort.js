...
function analyzePrices(supplierProducts, marketProducts) {
    ...
    matches.slice(0, 10).forEach((m, i) => {
        console.log('  ' + i + ': score=' + m.similarity + ' price=' + m.price + ' brand=' + (m.brand||'') + ' sameSpec=' + isSameSpec(supplierProduct, m) + ' needsReview=' + (m.needsReview||false) + ' title=' + m.title.substring(0, 30));
    });
}
