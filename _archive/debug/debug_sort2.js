...
function analyzePrices(supplierProducts, marketProducts) {
    ...
    matches.slice(0, 5).forEach((m, i) => {
        console.log('  top' + i + ': score=' + m.similarity + ' price=' + m.price + ' brand=' + (m.brand||'') + ' sameSpec=' + isSameSpec(supplierProduct, m) + ' needsReview=' + (m.needsReview||false) + ' title=' + m.title.substring(0, 30));
    });
}
