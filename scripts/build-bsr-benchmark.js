...
function aggregate(rows) {
  ...
  return {
    ...
    units_28d: { p25: pct(win.units, 0.25), p50: pct(win.units, 0.5), p75: pct(win.units, 0.75), p90: pct(win.units, 0.90) },
    avg_price_rub: { p25: pct(win.avg_price_rub, 0.25), p50: pct(win.avg_price_rub, 0.5), p75: pct(win.avg_price_rub, 0.75) },
    min_price_rub_p50: pct(win.min_price_rub, 0.5),
    sign_rate_p50: pct(win.sign_rate, 0.5),
    conv_rate_p50: pct(win.conv_rate, 0.5),
    cart_add_p50: pct(win.cart_add, 0.5),
    discount_p50: pct(win.discount, 0.5),
    promo_share_p50: pct(win.promo_share, 0.5),
    promo_days_p50: pct(win.promo_days, 0.5),
    ad_days_p50: pct(win.ad_days, 0.5),
    ad_roi_p50: pct(win.ad_roi, 0.5),
    oos_days_p50: pct(win.oos_days, 0.5),
    missed_sales_rub_p50: pct(win.missed_sales_rub, 0.5),
    volume_l_p50: pct(win.volume_l, 0.5),
