...
function analyzePrices(supplierProducts, marketProducts) {
    ...
    console.log('DBG SORT: total matches=' + matches.length);
    matches.slice(0, 10).forEach((m, i) => {
        console.log('  ' + i + ': score=' + m.similarity + ' price=' + m.price + ' brand=' + (m.brand||'') + ' sameSpec=' + isSameSpec(supplierProduct, m) + ' title=' + m.title.substring(0, 30));
    });
}
