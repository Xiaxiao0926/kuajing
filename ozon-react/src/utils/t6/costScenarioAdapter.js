...
export function scenarioSummary(scenario) {
  ...
  return {
    ...
    channelId: cfg.selectedChannel?.id ?? null,
    channelName: cfg.selectedChannel?.name ?? null,
    priceRub: scenario.inputPayload?.price ?? null,
    profitCny: Number.isFinite(out.profit) ? out.profit : null,
    profitMarginPct: Number.isFinite(out.profitRate) ? out.profitRate : null,
